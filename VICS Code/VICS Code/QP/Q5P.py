...
def main():
    ...
    # Folder paths for the files
    words_folder_q3 = os.path.join(script_dir, 'Q3P_txt')
    words_folder_q4 = os.path.join(script_dir, 'Q4P_txt')

    # File paths
    Internal_locus_file = os.path.join(words_folder_q3, 'Internal_locus.txt')
    External_locus_file = os.path.join(words_folder_q3, 'External_locus.txt')
    self_attributions_file = os.path.join(words_folder_q4, 'self_attributions.txt')
    other_attributions_file = os.path.join(words_folder_q4, 'other_attributions.txt')
    ...
    # Count words for Predictability Index (IQV)
    ...
    # Count words for Control Over Historical Development Index
    ...
    control_index = self_count / total_words if total_words else 0.0

    # Calculate Role of Chance Index
    role_of_chance = 1 - (predictability_value * control_index)
    ...
    print(f"Other Attributions words count: {other_count}")
    print(f"Control Over Historical Development Index: {control_index:.2f}")
    print(f"Role of Chance Index: {role_of_chance:.2f}")
